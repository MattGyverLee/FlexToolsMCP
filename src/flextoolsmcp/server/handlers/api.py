...
# Re-export for tests and callers that import from handlers.api.
...
DOMAIN_SYNONYMS = {
    ...
    "stem": "root base form",
    "inflection": "inflectional paradigm conjugation declension affix template slot position class chart PCC",
    "template": "affix template inflectional slot position class chart PCC morphological",
    "slot": "affix slot template position class chart PCC",
    "position class": "position class chart PCC affix template inflectional slot",
    "pcc": "PCC position class chart affix template inflectional slot",
    "chart": "chart affix template inflectional position class PCC constituent discourse ConstChart DsChart",
    "discourse": "discourse constituent chart ConstChart DsChart DsDiscourse analysis",
...
SEARCH_SYNONYMS = {
    ...
    "template": ["template", "templates", "affix", "slot", "inflectional", "chart", "pcc", "position"],
    "templates": ["template", "templates", "affix", "slot", "inflectional", "chart", "pcc", "position"],
    "slot": ["slot", "slots", "affix", "template", "position", "chart", "pcc"],
    "slots": ["slot", "slots", "affix", "template", "position", "chart", "pcc"],
    "inflectional": ["inflectional", "inflection", "affix", "template", "paradigm", "chart", "pcc"],
    "inflection": ["inflection", "inflectional", "affix", "template", "paradigm", "chart", "pcc"],
    "chart": ["chart", "charts", "affix", "template", "inflectional", "position", "pcc", "constituent", "discourse"],
    "charts": ["chart", "charts", "affix", "template", "inflectional", "position", "pcc", "constituent", "discourse"],
    "pcc": ["pcc", "chart", "position", "affix", "template", "inflectional", "slot"],
    "position": ["position", "class", "chart", "pcc", "affix", "template", "slot"],
    "discourse": ["discourse", "constituent", "chart", "constchart", "dschart", "dsdiscourse"],
    "constituent": ["constituent", "chart", "discourse", "constchart"],
}
    ...
    if include_casting_info and get_api_index().casting_index:
        ...
        if property_name in casting_props:
            ...
            result[KEY_PYTHONNET_CASTING] = {
                ...
                KEY_FLEXICON_HELPER: "Use cast_to_concrete(obj) -- from flexicon import cast_to_concrete"
            }
