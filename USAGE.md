...
| `flextools_parse_sandbox` | Parse on an exported copy of the grammar with FieldWorks' own HermitCrab engine, in a separate worker with no project open -- never touches the live project; rehearse speculative grammar edits in named sandboxes and re-run saved corpora |
