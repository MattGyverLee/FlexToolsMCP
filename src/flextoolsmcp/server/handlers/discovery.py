    ...
    for step in steps:
        ...
        if property_name in poly_collections:
            ...
            warning = {
                ...
                "suggestion": "Use cast_to_concrete(obj) to cast to the concrete type -- from flexicon import cast_to_concrete."
            }
            warnings.append(warning)

    if warnings:
        result[KEY_CASTING_WARNINGS] = warnings
        result[KEY_CASTING_HINT] = "This path accesses polymorphic collections. Use cast_to_concrete (from flexicon import cast_to_concrete) to access type-specific properties."
